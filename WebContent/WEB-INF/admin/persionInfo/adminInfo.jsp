...
<body>
	<table class="table table-striped" style="width:40%;margin-top: 200px;" align="center" >
	    <tr>
	    	<td>用户名:</td>
		...
		<tr>
			<td>密码:</td>
	    	<td><input id="adPassword" type="password" class="form-control"></td>
		</tr>
		<tr>
			<td>角色:</td>
		...
		<tr align="center"><td colspan="2"><button id="changeAdminUser" class="btn btn-primary">修改</button></td></tr>
	</table>
</body>
